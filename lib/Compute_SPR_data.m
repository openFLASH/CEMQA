...
function [HU, Densities, SPR, SP, RelElecDensity] = Compute_SPR_data(ScannerDirectory)
...
[Densities, SPR, SP, RelElecDensity] = HU_convert(HU,HU_Density_Data,Density_Data,HU_Material_Data,Material_Data);
